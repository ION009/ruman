-- 005: Stats hourly — pre-aggregated hourly metrics
-- SummingMergeTree: numeric columns auto-sum on merge
-- Populated by mv_stats_hourly materialized view from events

CREATE TABLE IF NOT EXISTS default.stats_hourly
(
...
-- Materialized view: auto-populates stats_hourly from every INSERT into events
CREATE MATERIALIZED VIEW IF NOT EXISTS default.mv_stats_hourly
TO default.stats_hourly
AS
SELECT
    site_id,
